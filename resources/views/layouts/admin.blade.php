...
<body class="bg-gray-50">
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen">
        ...
        <div class="lg:hidden fixed top-4 left-4 z-50">
            <button @click="sidebarOpen = true" class="p-2 bg-indigo-600 text-white rounded-lg">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.bookings') }}" @click="sidebarOpen = false"
                            class="flex items-center p-3 rounded-lg
                       {{ request()->routeIs('admin.bookings*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-100' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.rooms') }}" @click="sidebarOpen = false"
                    ...
                    <li>
                        <a href="{{ route('admin.feedbacks') }}" @click="sidebarOpen = false"
                            class="flex items-center p-3 rounded-lg text-gray-700 hover:bg-gray-100">
                    ...
                    <li class="pt-4 mt-4 border-t">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="flex items-center p-3 w-full text-red-600 hover:bg-red-50 rounded-lg">
